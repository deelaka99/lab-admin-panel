...
const Card = (props) => {
  ...
  return (
    <div
      className={`${
        color === "blue" ? "bg-blue1 dark:bg-black dark:bg-opacity-70" : color === "green" ? "bg-green dark:bg-black dark:bg-opacity-70" : color==="orange"?"bg-orange dark:bg-black dark:bg-opacity-70": "bg-blue dark:bg-black dark:bg-opacity-70"
